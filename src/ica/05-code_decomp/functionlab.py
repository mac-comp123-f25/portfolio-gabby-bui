"""
There are 5 turtles in total, each of them having different starting positions.
Each of the turtles draws the big 5 green circles outside first, and then draws the smaller 5 red circles
inside, and finally draws one small purple circle at the center.
"""
